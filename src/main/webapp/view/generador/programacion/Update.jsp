...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>sdstrp - Actualiza Programacion </title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-7">
                            <div class="breadcrumbs-area">
                                <h4 class="page-title pull-left">Actualización de Programación</h4>
                                ...
                                <div class="col-12">
                                    <div class="card mt-4">
                                        <div class="card-body">
                                            ...
                                            <form method="post" action="controlGenerador?action=residuoListaGenera" class="needs-validation" novalidate="">
                                                ...
                                                <div class="form-row">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Corriente Residuo</label>
                                                    </div>
                                                    <div class="col-md-4 mb-1">
                                                        <select class="form-control" name="tipDocu">
                                                ...
                                                <div class="form-row p-3">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Estado Materia </label>
                                                    </div>
                                                    ...
                                                    <div style="padding: 0% 1% 0% 3%;">
                                                        <label for="example-text-input" class="col-form-label">Ubicacion </label>
                                         ...
                                         <div class="form-row p-3">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Tipo Empaque </label>
                                                    </div>
                                                    <div class="col-sm-3 my-1">
                                                        <select class="form-control" name="tipDocu">
                                                            <option>Select</option>
                                                    ...
                                                    <div style="padding: 0% 1% 0% 3%;">
                                                        <label for="example-text-input" class="col-form-label">Tipo Embalaje </label>
                                        ...
                                        <div class="form-row p-3">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Tipo Gestion </label>
                                                    </div>
                                                    <div class="col-sm-3 my-1">
                                                        <select class="form-control" name="tipDocu">
                                                            <option>Select</option>
                                                    ...
                                                    <div style="padding: 0% 1% 0% 3%;">
                                                        <label for="example-text-input" class="col-form-label">Peligrosidad </label>
                                                ...
                                                <div class="form-row p-3">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Subtipo de Gestion </label>
                                                    </div>
                                                    <div class="col-sm-3 my-1">
                                                        <select class="form-control" name="tipDocu">
                                                            <option>Select</option>
                                        ...
                                        <div class="form-row p-3">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Transporte </label>
                                                    </div>
                                                    <div class="col-sm-3 my-1">
                                                        <select class="form-control" name="tipDocu">
                                                            <option>Select</option>
                                                    ...
                                                    <div style="padding: 0% 1% 0% 3%;">
                                                        <label for="example-text-input" class="col-form-label">Sede </label>
                                        ...
                                        <div class="form-row p-3">
                                                    <div style="padding: 1%;">
                                                        <label for="validationCustom01">Gestor </label>
                                                    </div>
                                                    <div class="col-sm-3 my-1">
                                                        <select class="form-control" name="tipDocu">
                                                            <option>Select</option>
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th><button class="btn btn-success mb-3" type="submit">Registrar</button></th>
                                                            <th><button class="btn btn-success mb-3" type="submit"><a href="controlGenerador?action=residuoListaGenera" class="text-white">Cancelar</a></button></th>
                                                            <th></th>
                                                            <th></th>
                                                        </tr>
                                                    </thead>
