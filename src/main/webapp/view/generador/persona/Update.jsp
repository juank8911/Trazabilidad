...
<html class="no-js" lang="en">
    ...
    <body data-sesion="${pSUsuario.numero_sesion}">
                ...
                <div class="row">
                            <!-- Server side start -->
                                <div class="card mt-4">
                                        ...
                                        <form method="post" action="controlGenerador?action=perfilActualiza" class="needs-validation form-control" novalidate="">
                                            ...
                                            <div class="form-row">
                                               ...
                                               <div class="form-group col-md-2">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <input type="text" name="txtUsu" class="form-control" id="validationCustom02"  value="${pSUsuario.usr_nombre}" required="">
                                                    <input type="hidden" name="txtIdusu" value="${pSUsuario.id_usr}">
                                                </div>
                                            </div>
                                            <div class="form-group form-control">

                                                    <button class="btn btn-success mb-3" type="submit">Actualizar Informacion</button>
                                                    <c:choose>
                                                    <c:when test="${pSUsuario.numero_sesion == 1}">
                                                    <button class="btn btn-success" type="submit"><a href="control?action=perfilLee" class="text-white">Cancelar</a></button>
                                                    </c:when>
                                                    </c:choose>
