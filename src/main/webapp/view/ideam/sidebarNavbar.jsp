<%-- 
    ...
    Created on : 24/09/2020, 09:44:43 AM
    Author     : yorman
--%>
<!-- SIDE BAR DE -->
<!--[if lt IE 8]>
			...
			<div class="menu-inner">
				<nav>
					<ul class="metismenu" id="menu">
						<li><a href="controlIDEAM?action=ideam"><i
						...
						<li class="active"><a aria-expanded="true"><i
							...
							<ul class="collapse">
								<li><a method="post" href="controlIDEAM?action=ideamClave"
						...
						<li class="active"><a aria-expanded="true"><i
							...
							<ul class="collapse">
								<li><a method="post"
									href="controlIDEAM?action=ideamEmpresaLista"
									aria-expanded="true"><i class="fa fa-university"></i><span>Empresa</span></a></li>
								<li><a href="controlIDEAM?action=ideamSedeLista"
									aria-expanded="true"><i class="fa fa-building"></i><span>Establecimiento</span></a></li>
								<li><a href="controlIDEAM?action=ideamUsuLista"
									aria-expanded="true"><i class="ti-user"></i><span>Usuarios</span></a></li>
							</ul></li>
						<li class="active"><a aria-expanded="true"><i
								class="ti-angle-down"></i><span>Consultas</span></a>
							<ul class="collapse">
								<li><a href="controlIDEAM?action=ideamDeclaLista"
									aria-expanded="true"><i class="ti-files"></i><span>Historico</span></a></li>
								<li><a href="controlIDEAM?action=ideamIndiLista"
									aria-expanded="true"><i class="fa fa-pie-chart"></i><span>Indicadores</span></a></li>
								<li><a href="controlIDEAM?action=ideamSalidaLista"
