...
<%@taglib prefix="demo" tagdir="/WEB-INF/tags"%>
    ...
    <demo:header/>     
        ...
        <script src="assets/js/indicadoresTrans.js"></script>
    </head>
	...
	<div class="row justify-content-md-center">
			...
			<select class="form-select" aria-label="select" onchange="cambioChar(this)" id="select_id">
	  			<option selected value="1">Cantidad anual de residuos peligrosos movilizados, por corriente de residuos</option>
