                    ...
                    <div class="col-12">
                        <div class="card mt-4">
                            <div class="card-body">
                                ...
                                <form method="post" action="control?action=perfilLee" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-row p-3">
                                        ...
                                        <div class="col-sm-3 my-1">
                                            <input type="text" name="cargoUsu" class="form-control" id="validationCustom02"  value="" required="">
                                        </div>
                                        ...
                                        <div class="col-sm-3 my-1">
                                            <input type="text" name="telUsu" class="form-control" id="validationCustom02"  value="" required="">
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-1">
                                            <input type="text" name="emailUsu" class="form-control" id="validationCustom02"  value="" required="">
                                        </div>
                                    </div>
                                    <br />
