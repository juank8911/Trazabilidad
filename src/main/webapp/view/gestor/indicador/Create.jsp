                    ...
                    <div class="menu-inner">
                        <nav>
                            <ul class="metismenu" id="menu" >
                                <li><a href="ControlGestor?action=gestor"><i class="ti-dashboard"></i> <span>Inicio</span></a></li>
                                <li class="active">
                                    <a aria-expanded="true"><i class="ti-angle-down"></i><span>Información</span></a>
                                    <ul class="collapse">
                                        <li><a method="post" href="ControlGestor?action=empresaGestor" aria-expanded="true"><i class="fa fa-university"></i><span>Empresa</span></a></li>
                                        <li><a href="ControlGestor?action=sedeGestor" aria-expanded="true"><i class="fa fa-building"></i><span>Establecimiento</span></a></li>
                                        <li><a href="ControlGestor?action=perfilLeerGestor" aria-expanded="true"><i class="fa fa-male"></i><span>Perfil</span></a></li>
                                ...
                                <li class="active">
                                    ...
                                    <ul class="collapse">
                                        <li><a method="post" href="ControlGestor?action=servicioListaGestor" aria-expanded="true"><i class="fa fa-university"></i><span>Servicios Prestados</span></a></li>
                                        <li><a href="ControlGestor?action=autorizaListaGestor" aria-expanded="true"><i class="fa fa-building"></i><span>Autorizaciones Ambientales</span></a></li>
                                        <li><a href="ControlGestor?action=finalizaListaGestor" aria-expanded="true"><i class="ti-user"></i><span>Finalizacion</span></a></li>
                                    </ul>
                                </li>
                                <li class="active">
                                ...
                                <li><a href="ControlGestor?action=gestor"><i class="ti-shift-right"></i> <span>Cerrar Sesion</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="main-content">
                ...
                <div class="single-table">
                    <div class="table-responsive">
                        ...
                        <button class="btn btn-success mb-3" type="submit"><a href="ControlGestor?action=gestor" class="text-white">Cancelar</a></button>
                    </div>
                </div>
                <!--/div-->
                <!--/div-->
