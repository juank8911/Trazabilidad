...
<link href="<c:url value='/assets/css/styles/kendo.common.min.css'/>"
	rel="stylesheet" />
<link href="<c:url value='/assets/css/styles/kendo.metro.min.css'/>"
	rel="stylesheet" />
...
<script
	src="<c:url value='/assets/js/kendo/cultures/kendo.culture.es-CO.min.js' />"></script>
<script
